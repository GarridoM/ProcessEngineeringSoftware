	var mgame=require("./game.js");
	var mboard=require("./board.js");
	var mdice=require("./dice.js");
...
describe("Monopoly", function(){
	...
	beforeEach(function(){
		...
		diceOne = new mdice.Dice();
		diceTwo = new mdice.Dice();
		...
		numberBoxes = 40;		
		board = new mboard.Board(numberBoxes);
		board.configureBoard();
		times = 0;
		game = new mgame.Game(diceOne, 2);
		game2 = new mgame.Game(diceOne, 6);
		usr1 = new muser.User("Lola");
		usr2 = new muser.User("Luis");
